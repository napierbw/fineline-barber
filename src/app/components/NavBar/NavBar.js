...
const NavBar = () => {
  const [top, setTop] = useState(
    typeof window !== "undefined" ? !window.scrollY : true
  );
    ...
    >
      <div className="flex flex-row justify-between items-center py-2">
        <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
          <Link href="/#hero">
            <h1 className="font-extrabold text-4xl text-yellow-500 whitespace-nowrap">
              | Fine Line |
            </h1>
          </Link>
        </div>
        <div className="group flex flex-col items-center">
          <button
            ...
            className="p-2 rounded-lg lg:hidden text-yellow-500"
            onClick={handleClick}
          >
            <svg
